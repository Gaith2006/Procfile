...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=484098782158651392&permissions=8&scope=bot').setDescription(`**
...
client.users.get("406877114936197120").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
client.on('message',function(message) {
 ...
 ONLINE:   ${message.guild.members.filter(m=>m.presence.status == 'online').size}
  NOT DISTURB       ${message.guild.members.filter(m=>m.presence.status == 'dnd').size}
  IDLE:     ${message.guild.members.filter(m=>m.presence.status == 'idle').size}
  OFLINE:     ${message.guild.members.filter(m=>m.presence.status == 'offline').size}
